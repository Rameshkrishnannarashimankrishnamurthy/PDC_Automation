...
public class CDCPage extends BaseClass {

    public CDCPage(WebDriver driver, WebDriverWait wait) {
        super(driver, wait);
   ...
   /* public void getOurVolunteers() throws Exception {
        try
        {
            ...
            request.method("https://uottawa-pdcweb.herokuapp.com/ourVolunteers/all");
        }
        catch (Exception e)
        {
